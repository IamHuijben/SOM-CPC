...
if __name__ == "__main__":
    ...
    """
    Librsipreech CPC runs
    """
    runs = []
    runs_names = []

    runs.append({})
    runs_names.append('CPC_audio')

    runs.append({
    'model.classifier.input_channels': 2,
    'model.classifier.output_channels': [2],
    'model.encoder.channels': [512, 512, 512, 512, 2],
    'model.ARmodel.input_size': 2,
    'model.ARmodel.output_size': 2
    })
    runs_names.append('CPC_audio_zdim2')
