...
if __name__ == "__main__":
    ...
    """
    Test with a new set of toy data, in which the three sources are truely independent and the magnitudes are unnormalized.
    """
    ...
    runs_names.append('CPC_synthetic')

    runs.append({
        'model.classifier.input_channels': 2,
        'model.classifier.output_channels': [2],
        'model.encoder.channels': [16, 32, 64, 2],
    })
    runs_names.append('CPC_synthetic_zdim2')
